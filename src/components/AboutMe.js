  ...
  return (
    <section id="aboutMe" className="aboutMeSection">
      ...
      <p className="">
        ...
        velit, posuere sed tellus a, semper finibus lacus. Integer sit amet nibh
        augue. Mauris interdum egestas interdum. Pellentesque at dictum odio, et
        ultricies lectus. Nulla sit amet elementum tellus. Phasellus mattis
        scelerisque purus quis porttitor. Donec vehicula sapien non dui
